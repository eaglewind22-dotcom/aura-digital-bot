...
// FIXED: Emoji မပါသော စာသားစစ်စနစ်အတွက် Admin Menu ကို ရှင်းလင်းစွာ ပြင်ဆင်ခြင်း
...
// ==========================================
// 7. ADMIN CONTROLS (FIXED - NO EMOJI IN BOT.HEARS)
// ==========================================
...
bot.hears('Promo Code အသစ်ထုတ်ရန်', (ctx) => {
